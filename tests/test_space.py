...
def test_create_space():
    space = Space(1, "Space1", "1st Street", "City1", "House", 4, 2, 1, 100, 1)
    assert space.id == 1
...
"""
def test_equality():
    space1 = Space(1, "Space1", "1st Street", "City1", "House", 4, 2, 1, 100, 1)
    space2 = Space(1,"Space1", "1st Street", "City1", "House", 4, 2, 1, 100, 1)
...
def test_formatting():
    space = Space(1, "Space1", "1st Street", "City1", "House", 4, 2, 1, 100, 1)
    assert str(space) == "1, Space1, 1st Street, City1, House, 4, 2, 1, 100, 1"